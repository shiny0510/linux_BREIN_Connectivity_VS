...
<body>
	...
	var fname = '<%=lists%>';
	var ftype = '<%=fileType%>';
    var url = 'http://brein.korea.ac.kr/brainorigin/saf/T1FileDatabaseAddController?lists='+fname+'&pname=<%=pname%>&id=<%=id%>&pnum=<%=pnum%>'; 
  /*   var url = 'http://brein.korea.ac.kr/brainorigin/saf/T1FileDatabaseAddController'; 
 */

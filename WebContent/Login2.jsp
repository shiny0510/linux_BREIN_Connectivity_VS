...
<head>
	...
	<link rel="stylesheet" type="text/css" href="LoginForm/css/main2.css">
...
<body style="background-color: #c6f1ff;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login200-form validate-form" name="f" action="${pageContext.request.contextPath }/LoginMemberController" method="post">


					<span class="login100-form-title p-b-43">
					<img src="https://img.icons8.com/ios/50/000000/brain.png">
						BrainViewer Create account
					</span>
	...
	<script src="LoginForm/js/main2.js"></script>

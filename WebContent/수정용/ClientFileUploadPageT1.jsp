...
alert(fileName);
	...
	<form action="FileUploadResult.jsp?bowl_" method="post" enctype="multipart/form-data">
		<table>
	...
	<table>
	<tr>
	<td><textarea  wrap="hard" spellcheck = "false" name='textbox2' style='height:1000px; width:1000px;' ></textarea></td>
	</tr>
	</table>
</body>
</html>
...
<body>
	...
	<table class="ubutton">
		<tr>
			...
			<td><label>파일체크</label></td>
			<td>
				<button onclick="location.href ='DataprocessingServlet'" method="post">전처리</button> <%-- 		<form id="f" name="f"action="${pageContext.request.contextPath}/screenAddController"method="post">
					<button class="ubutton" src="${pageContext.request.contextPath }/DataprocessingServlet">전처리</button>			
				</form> --%>
			</td>
